  ...
  return (
    <header className="max-w-5xl mx-auto p-4 flex">
      ...
      <div className="flex items-center justify-end md:flex-1 lg:w-0 space-x-8">
        <a
          href="https://www.barkpass.com"
          target="_blank"
          className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300 inline-flex items-center space-x-1"
        >
          <span>barkpass.com</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="none"
